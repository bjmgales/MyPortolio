...
export default function Svg({
    ...
    function fadeOut(){
        ...
        createKeyframesOut(props.pos_x, props.pos_y,
            props.hide_x, props.hide_y, animation, [1, 0], [1, 0])
        setStyle((prev)=>({...prev, animation : `${animation} 1s linear forwards`}))
    }
    ...
    function fadeIn(){
        ...
        createKeyframesIn(props.hide_x, props.hide_y,
            props.pos_x, props.pos_y, animation, [0, 1], [10, 1])
        setStyle((prev)=>({...prev, animation : `${animation} 1s linear forwards`}))
    }
